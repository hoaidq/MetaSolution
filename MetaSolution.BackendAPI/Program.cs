...
builder.Services.AddIdentity<User, Role>()
                .AddEntityFrameworkStores<MetaDbContext>()
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger Meta Solution", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger Meta Solution V1");
});
